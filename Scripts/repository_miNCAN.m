...
%Change option.startFolder with your starting folder containing two
%sub-folder: Data and Scripts

option.startFolder ='D:\0-MATLAB\MotorImageryGaitEEG';

option.saveFolder = [option.startFolder,'\Data'];
